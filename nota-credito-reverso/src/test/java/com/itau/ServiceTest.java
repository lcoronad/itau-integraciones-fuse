...
//	              weaveByToUri(Constant.ROUTE_CONSUMO_SOAP).replace().inOut("mock:routeB").removeHeaders("*").to("velocity:templates/response1.vm");
		...
		ResponseEntity<String> r = restTemplate.exchange(URL + serverPort + "/accounts/v1/accounts/123456/credit_transactions/234234", HttpMethod.DELETE,httpEntity,String.class);
