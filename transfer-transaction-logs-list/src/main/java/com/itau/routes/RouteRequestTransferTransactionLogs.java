	...
	public void configure() throws Exception {
		...
		.choice()				
			.when(PredicateBuilder.and(exchangeProperty(STATUS_VALIDATOR).isEqualTo("000"), exchangeProperty(SEVERITY_VALIDATOR).isEqualTo("Info")))
				...
				.setProperty(Constants.TRANSFERTRANSACTIONINFO).jsonpath("$.Body.getTransferTransactionLogListRs.TransferTransctionInfoList.*")
				.log(LoggingLevel.DEBUG, logger, "Proceso: ${exchangeProperty.procesoId} | Mensaje: ${exchangeProperty.TransferTransactionInfo}")
