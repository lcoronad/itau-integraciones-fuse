...
public class Constants {
	...
	public static final String ROUTE_REQUEST_TRANSACTION_FEE = "direct:route-request-transaction-logs";
	...
	public static final String FROMPHONENUM = "FromPhoneNum";
	public static final String TOPHONENUM = "ToPhoneNum";
	public static final String TRANSFERTRANSACTIONINFO = "TransferTransactionInfo";
